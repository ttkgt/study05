...
<?php echo Form::open(array('action'=>'index/send','class' => 'form-horizontal'));?>
...
<div class="form-group">
    <label for="" class="col-sm-4 control-label">ラジオボタン</label>
    <div class="col-sm-8">
      <p class="control-label" style="text-align: left;"><?php echo $item;?></p>
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
      <p class="control-label" style="text-align: left;"><?php echo $select[$item2];?></p>
    </div>
  </div>
