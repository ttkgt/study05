...
<?php echo Form::open('http://localhost/study05/cropimg3/index');?>
...
//	});
	...
	//背景画像を移動させたとき、多少のズレが生じるのでマウスを離したときに再表示際の位置をセッション変数に保存
	$('#<?php  echo $_SESSION['itemCd'];?>').mouseup(function(){
		//背景移動時の要素のズレ防止のため、0.01秒の遅れを発生させる
		setTimeout(function(){
...
//				$('<form/>', {action: 'http://localhost/study05/edittest/index', method: 'post'})
				$('<form/>', {action: 'http://localhost/study05/cropimg3/edit', method: 'post'})
